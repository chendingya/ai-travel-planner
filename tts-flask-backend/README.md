...
旅游小程序的语音合成和 AI 对话后端服务，基于 Flask 框架，集成了阿里云 DashScope TTS API 和魔搭社区 LLM。

## 功能特性

- 🗣️ **文字转语音（TTS）**：支持将文本转换为自然流畅的语音
- 🤖 **AI 智能对话**：结合大语言模型提供旅游咨询服务
...
```json
{
  "user_message": "推荐一下杭州的旅游景点",
  "ai_response": "杭州有很多著名景点...",
  "voice": "Cherry",
  "language_type": "Chinese",
  "audio_url": "https://dashscope.oss-cn-beijing.aliyuncs.com/..."
}
...
```json
{
  "user_message": "详细介绍一下杭州旅游",
  "ai_response": "杭州是一个充满魅力的城市...",
  "voice": "Cherry",
  "language_type": "Chinese",
  "audio_urls": [
