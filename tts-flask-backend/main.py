...
async def ai_chat():
    ...
    try:
        ...
        try:
            ...
            # 构造对话历史（维持上下文）
            system_prompt = "你是一个专业的旅游助手，你的任务是为用户提供关于旅游的专业建议和信息。请用友好、专业的语气回答用户的问题。回答要求：1. 使用纯文本格式，不要使用Markdown或其他格式；2. 回答要简洁明了，突出重点；3. 提供实用的旅游建议和信息。"
            ...
            ai_response = "杭州是一个充满魅力的旅游胜地，拥有丰富的自然风光和人文景观。我为您推荐西湖、灵隐寺、宋城等经典景点，每个地方都值得细细品味。"
